...
import com.j5erp.entity.Enquiryson;
...
public interface EnquirysonMapper {
    /**
     ...
     */
    @Insert({
        "insert into ENQUIRYSON (ID, LINE, ",
        "FID, WID, FROMID, ",
        "FROMTYPE, PRICE, ",
        "NUM, TIME, NOTNUM, ",
    ...
    @ConstructorArgs({
        ...
        @Arg(column="NUM", javaType=BigDecimal.class, jdbcType=JdbcType.DECIMAL),
        @Arg(column="TIME", javaType=Date.class, jdbcType=JdbcType.TIMESTAMP),
        @Arg(column="NOTNUM", javaType=BigDecimal.class, jdbcType=JdbcType.DECIMAL),
    ...
    Enquiryson selectByPrimaryKey(@Param("id") String id, @Param("line") Integer line, @Param("fid") String fid, @Param("wid") String wid);
    ...
    int updateByPrimaryKey(Enquiryson record);
}